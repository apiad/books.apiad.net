  ...
  "categories": [
    {
      ...
      "description": "Books for a broad readership. No prior CS background required — written for curious minds who want the big ideas without the equations or code.",
      "banner": {
        "text": "Especial Sale: Use FIFTYOFF discount code for a 50% discount on any book",
      ...
      "items": [
        ...
        {
          "id": "philosophy",
          "title": "The Computist Guide to Philosophy",
          "audience": "😄 General",
          "description": "Twenty questions at the intersection of computer science and philosophy. From consciousness and free will to intelligence, meaning, and the nature of computation itself.",
          "fullDescription": "A book-length exploration of the philosophical questions that computer science forces us to take seriously. What is intelligence? Can machines think? What does it mean to compute? Is the universe itself computational? Twenty chapters, each anchored by a single question, each grounded in the current state of CS and AI while opening onto the deeper philosophical stakes. Written for curious readers with no prior background in either discipline.",
          "status": "Scaffold",
          "statusEmoji": "🔵",
          "progress": 5,
          "pages": 65,
    ...
    },
    {
      "id": "technical",
      "name": "🛠️ Technical",
      "description": "Books for practitioners and CS-adjacent readers. Assume basic programming literacy; go deep on models, algorithms, systems, and formal ideas.",
      "banner": {
        "text": "Especial Sale: Use FIFTYOFF discount code for a 50% discount on any book",
        "bgGradient": "from-orange-500/20 to-red-500/20",
        "borderColor": "border-orange-800/50"
      ...
      "items": [
        ...
        {
          "id": "graphs",
          "title": "Graphs: Theory, Practice, and Applications",
          "audience": "😎 Technical",
        ...
        },
        {
          ...
          "audience": "😎 Technical",
          "description": "A literate-programming reference on algorithms and data structures. Five parts, 38 chapters, code tangled directly from the manuscript. From fundamentals to advanced techniques.",
          "fullDescription": "A comprehensive reference on algorithms and data structures, written in literate-programming style — every chapter is both prose and working code, tangled together from a single source. Five parts cover fundamentals, sorting and searching, graph algorithms, advanced data structures, and applied techniques (dynamic programming, greedy methods, approximation, randomization). Designed as a companion to a serious CS education, not a first introduction.",
          "status": "Release Candidate",
          "statusEmoji": "🟢",
          "progress": 95,
          "pages": 452,
          "targetPages": 450,
          "price": 2900,
          "gumroadUrl": "https://apiad.gumroad.com/l/codex",
          "readUrl": "/books/codex",
          "coverUrl": "/books/codex/cover.jpg",
          "hint": "Use FIFTYOFF discount code for a 50% discount!",
          "salesCount": 0
        }
      ]
    },
    {
      "id": "backburner",
      "name": "❤️‍🔥 Backburner",
      "description": "Ideas for books based on courses I've taught. Codenames only — no release dates, some may never ship.",
      "items": [
        {
          "id": "think-like-cs",
