...
My books are written for three kind of audiences:

- **😄 General:** A book that can be read by anyone, regardless of their background.
- **😎 Technical:** A book for technical audiences, not necessarily with formal education on math or computer science, but with working knowledge in programming.
- **🧐 Expert:** A book for experts, mostly requiring formal education in math and/or computer science or a deep understanding of the underlying theory.
...
A book on the ten most beautiful algorithms ever created (according to me). This book is intended to introduce audiences to the beautiful world of algorithm design without any technical baggage. It will cover algorithms from all areas of computer science, from simple ideas like search and graph algorithms to fundamental fields like crytography to concrete applications like neural networks, compression, and 3D rendering.
